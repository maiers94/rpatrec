...
c <- test.smoother(n=5,m=10,incr=0.5,max=80,smoother = kernel,bandwidth=3)
...
e <- test.smoother(n=5,m=10,incr=0.5,max=50,smoother = savgolay,width = 11)
f <- test.smoother(n=5,m=10,incr=0.5,max=50,smoother = savgolay,width = 12)
attach(mtcars)
par(mfrow=c(3,2))
...
```{r, fig.show='hold'}
a <- test.smoother(n=5,m=10,incr=0.5,max=50,smoother = savgolay, width = 10, degree = 1)
b <- test.smoother(n=5,m=10,incr=0.5,max=50,smoother = savgolay, width = 10, degree = 2)
c <- test.smoother(n=5,m=10,incr=0.5,max=50,smoother = savgolay, width = 10, degree = 3)
d <- test.smoother(n=5,m=10,incr=0.5,max=50,smoother = savgolay, width = 10, degree = 4)
attach(mtcars)
par(mfrow=c(2,2))
