...
plot(a, type="l", ylab="% of patterns recognised", xlab="noise", main="Width = 7")
plot(b, type="l", ylab="% of patterns recognised", xlab="noise", main="Width = 8")
plot(c, type="l", ylab="% of patterns recognised", xlab="noise", main="Width = 9")
plot(d, type="l", ylab="% of patterns recognised", xlab="noise", main="Width = 10")
```
